...
namespace ObiGarm.Users.Spitalists
{
    public partial class AddSpitalist : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void addAdmin()
        {
            ...
            string sql_user_check = "select * from users where name = '" + name_spitalist + "' and surname = '" + surname_spitalist + "' and point= '2' and deleted is null";


            string sql_add_user = "insert into users (name, surname, point, room_number, id_manitor, work_time_start, end_date_time_services, work_time_end) values('" +
            ...
            if (name_spitalist.Trim() != "" && surname_spitalist.Trim() != ""
