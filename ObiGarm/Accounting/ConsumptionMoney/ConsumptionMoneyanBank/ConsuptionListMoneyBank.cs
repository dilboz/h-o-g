...
{
    public partial class ConsuptionListMoneyBank : DevExpress.XtraEditors.XtraForm
    {

        SqlConfiguration sqlConfiguration;

        public ConsuptionListMoneyBank()
        {
            InitializeComponent();
        ...
        public void display()
        {
            ...
            string sql_load_all_sum_money = "SELECT sum(number_money) AS 'sum_consuption', max(date) as 'max_date', min(date) as 'min_date' FROM consuption_money_bank where enable = 1 ;";
        ...
        private void ConsuptionListMoneyBank_Shown(object sender, EventArgs e)
        {
            display();
        }
        ...
        private void delete_button_ButtonClick(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            ...
            {
                string sqlDeleteAdmin = $"update consuption_money_bank set deleted= '{DateTime.Now.ToString("yyyy'-'MM'-'dd'_'HH':'mm':'ss")}',  enable='0' where id = '" + id + "'";
        ...
        {
            ConsuptionAddMoneyBank consuptionAddMoneyBank = new ConsuptionAddMoneyBank(this, "", "Сохтан"); 
            consuptionAddMoneyBank.ShowDialog();
        }
        ...
        private void edit_button_ButtonClick(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            ...
            if (id != "")
            {
                ConsuptionAddMoneyBank consuptionAddMoneyBank = new ConsuptionAddMoneyBank(this, id, "Иваз кардан");
                consuptionAddMoneyBank.ShowDialog();
            }
        }
    }
