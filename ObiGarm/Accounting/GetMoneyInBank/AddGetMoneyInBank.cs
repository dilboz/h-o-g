...
{
    public partial class AddGetMoneyInBank : DevExpress.XtraEditors.XtraForm
    {
        SqlConfiguration sqlConfiguration;
        private readonly ListGetMoneyInBank listGetMoneyInBank;
        private string id_list_money_bank;
        private string text_button;

        public AddGetMoneyInBank(ListGetMoneyInBank listGetMoneyInBank, string id_list_money_bank, string text_button)
        {
            InitializeComponent();
            sqlConfiguration = new SqlConfiguration();
            this.listGetMoneyInBank = listGetMoneyInBank;
        ...
        void add()
        {
            ...
            string add_get_money = $"INSERT INTO list_money_bank (name, id_name_bank, number_money, date) VALUES ('{name}', '{id_name_bank}', '{nuber_money}', '{date}');";
        ...
        void update(string id)
        {
            ...
            string update_get_money = $"UPDATE list_money_bank SET name = '{name}', id_name_bank = '{id_name_bank}', number_money = '{nuber_money}', date = '{date}' WHERE (`id` = '{id}');";
        ...
        private void AddGetMoneyInBank_Shown(object sender, EventArgs e)
        {
            loadCombo();
